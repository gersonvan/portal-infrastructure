...
#### Acadêmico
* Censo Aluno
* Diploma (Antigo, teoricamente está desabilitado)
* Diploma Digital (É o que é usado hoie)
* Dou
* Ementa
* Gerar Arquivo Diploma
* Gerar Arquivo Diploma Digital
...
"""
# Levantamento de Requisitos - Mapeamento do Portal Antigo (arquivado)

Arquivo original de levantamento/mapeamento do portal antigo. Mantido para referência histórica e migração.

---

## Conteúdo (resumo)

Este documento contém o mapeamento dos módulos e funcionalidades do portal antigo — Acadêmico, Administrativo, Coordenação, Financeiro, RH, Relacionamentos, Relatórios e Configurações — com listas detalhadas de features (Diploma, Diploma Digital, Censo Aluno, Emissão de Notas Fiscais, Lotação de Docentes, etc.).

(Conteúdo completo arquivado — consulte a versão histórica no repositório para detalhes.)

---

**Observação:** o arquivo `docs/REQUIREMENTS.md` foi substituído por um wrapper que referencia este mapeamento histórico e descreve próximos passos para atualizar os requisitos para o novo Portal Administrativo.
